...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="adminpage.php">
  ...
  <div class="sidebar-brand-text mx-3">User Management</sup></div>
</a>
...
<li class="nav-item">
  ...
  <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      ...
      <a class="collapse-item" href="M_Account.php">Account</a>
      <a class="collapse-item" href="M_Personal.php">Personal</a>
